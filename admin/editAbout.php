...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_SESSION['password']) && isset($_SESSION['username'])) {
        ...
        <html>
            ...
            <body>
                <div id="wrap">
                    ...
                    <div class="container">
                        <?php
                        $editAbout = mysql_query("SELECT * FROM tentang WHERE id_tentang = '$_GET[id]'");
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" placeholder="title" class="form-control" id="inputPassword3" name="tentang" value="<?php echo $dataAbout['judul_tentang'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Content</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="content" name="isi" rows="16" required><?php echo $dataAbout['isi_tentang'] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" name="updateAbout" data-loading-text="Loading..." class="btn btn-success">Save</button>
                                        <input type="button" value="Cancel" onclick="document.location = './about_us.php';" class="btn btn-default">
                                    </div>
                                </div>
                            </fieldset>
                        </form>
        ...
        if (isset($_POST['updateAbout'])) {
            ...
            $sql = mysql_query("UPDATE tentang SET judul_tentang='$title', isi_tentang='$content' WHERE id_tentang = '$id_tentang'");
            if ($sql) {
