...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_SESSION['password']) && isset($_SESSION['username'])) {
        if ($_GET['del']) {
            $query = mysql_query("DELETE FROM kontak WHERE id_kontak = '$_GET[del]'");
            if ($query) {
                echo "<script>alert('Data kontak has been deleted');</script>";
            }
        }
        ?>
        <!DOCTYPE>
...
>>>>>>> 16b127ddcd9ca20f84623b75b6f75a0e16df8f10
                        ...
                        if ($paging == 0) {
                            ...
                            <div class="alert alert-warning">
                                ...
                                <p><button onClick="document.location = 'addContact.php';" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span> Add New Contact</button></p>
                            </div>
                            <?php
                        }
...
>>>>>>> 16b127ddcd9ca20f84623b75b6f75a0e16df8f10
                                                ...
                                                <td style="text-align: center;width: 25%" colspan="2">
                                                    ...
                                                    <a href="?del=<?php echo $row[id_kontak]; ?>" class="btn btn-danger" id="element" data-toggle="tooltip" title="remove user" onClick="return confirm('Are you sure?');">
                                    ...
                                    <?php
                                    $halaman = "SELECT COUNT(*) AS jumData FROM kontak";
...
>>>>>>> 16b127ddcd9ca20f84623b75b6f75a0e16df8f10
                                    ...
                                    echo "</ul><span class='label label-info pull-right'>Total Contact : $jumData</span>";
                                    ?>
