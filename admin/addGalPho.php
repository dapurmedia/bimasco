                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" placeholder="Title..." class="form-control" maxlength="15" name="titlePho" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Place</label>
                                         <div class="col-sm-3">
                                            <input type="text" placeholder="Place" class="form-control"  maxlength="25" name="placePho" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Description</label>
                                         <div class="col-sm-3">
                                            <textarea rows="5" class="form-control" name="descriptionPho" maxlength="150" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
