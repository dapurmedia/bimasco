...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_SESSION['password']) && isset($_SESSION['username'])) {
        ...
        <html>
            ...
            <body>
                <div id="wrap">
                    ...
                    <div class="container">
                        <?php
                        $editUser = mysql_query("SELECT * FROM users WHERE username = '$_SESSION[username]'");
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form" id="form" class="form-horizontal" onSubmit="return validasi(this);">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="col-sm-10">
                                            <p class="form-control-static"><strong><?php echo $dataUser['status']; ?></strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" name="updateAcct" data-loading-text="Loading..." class="btn btn-success">Save</button>
        ...
        if (isset($_POST['updateAcct'])) {
            ...
            $sql = mysql_query("UPDATE users SET password='$pswd', email='$email' WHERE id_users = '$id_user'");
            if ($sql) {
