    ...
    if (isset($_SESSION['password']) && isset($_SESSION['username'])) {
            ...
            <head>
                ...
                <script type="text/javascript">
                    ...
                    function validasi(form) {
                        ...
                        //validation space, delete space from first and end
                            ...
                            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" name="form" class="form-horizontal" enctype="multipart/form-data" onSubmit="return validasi(this);">
                                ...
                                <fieldset>
                                   ...
                                   <div class="form-group">
										...
										<div class="col-sm-3">
                                            <input name="video" class="form-control" value="Video" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="saveAlb" data-loading-text="Loading..." class="btn btn-success">Save</button>
                                            <input type="button" value="Cancel" onclick="document.location = 'galeriVid.php';" class="btn">
                                        </div>
                                    </div>
                                 </fieldset>
                            </form>
        ...
        if (isset($_POST['saveAlb'])) {
            ...
            if ($stop == 1) {
                ...
                description_album = '$descriptionAlb', written='$_SESSION[username]', type_album='$typeAlb'");

                if ($sql) {
                    echo "<script>alert('New Video Album has been saved');</script>";
                    echo "<script>javascript:window.location='./galeriVid.php'</script>";
                } else {
                    echo "<script>alert('New Video Album cannot be saved');</script>";
                }
            }
        }
    }
