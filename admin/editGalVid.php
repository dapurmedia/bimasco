...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_SESSION['password']) && isset($_SESSION['username'])) {
               ...
               <div id="wrap">
                    ...
                    <div class="container">
                            ...
                            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" name="form" class="form-horizontal" onSubmit="return validasi(this);">
                                <legend>Edit Album Video</legend>
                                <fieldset>
        ...
        description_album = '$descriptionAlb', written='$_SESSION[username]', type_album='$video' WHERE id_album = '$id_album'");
            if ($sql) {
                echo "<script>alert('Album Video has been updated');</script>";
                echo "<script>javascript:window.location='./galeriVid.php'</script>";
            } else {
                echo "<script>alert('Album Video cannot be updated');</script>";
            }
        }
    }
}
